...
class XDistralLearner:
    ...
    def __init__(self, mac, logger, main_args):
        ...
        self.mac.pi_i_mixer = copy.deepcopy(self.pi_mixers)
    ...
    # 最小化pi_i和pi_0之间的距离,注意学的是pi_0        
    def minmize_policy_dist(self, batchs, t_env: int, episode_num: int, task):
        loss = 0
        # for task in self.task2args:
        batch = batchs[task]
    ...
    def rl_train(self, batch: EpisodeBatch, t_env: int, episode_num: int, task: str):
        ...
        self.optimize_pi_0(batch, t_env, episode_num, task)
        #优化完后更新mac中的pi_0_mixer和pi_i_mixer
        self.mac.pi_0_mixer = copy.deepcopy(self.mixer)
        self.mac.pi_i_mixer = copy.deepcopy(self.pi_mixers)
